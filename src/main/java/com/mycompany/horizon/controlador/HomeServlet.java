...
public class HomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       if (session != null && session.getAttribute("usuario") != null) {
            ...
            // Cargar cursos en progreso dinámicamente
            com.mycompany.horizon.modelo.CursoDAO cursoDAO = new com.mycompany.horizon.modelo.CursoDAO();
            java.util.List<com.mycompany.horizon.modelo.Curso> cursosEnProgreso = cursoDAO.obtenerCursosEnProgreso(usuario.getIdUsuario());
            
            request.setAttribute("cursosEnProgreso", cursosEnProgreso);
